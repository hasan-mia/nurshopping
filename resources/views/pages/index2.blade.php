         ...
         <div class="row">
            ...
            <div class="col-6 col-sm-4 col-lg-2">
               <div  class="top-product-card">
                  ...
                  <a  href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}" class="product-thumbnail d-block">
                     <div class="app-img mb-2 app-img--loaded"> 
                        <img src="{{ asset( $row->image_one )}}" alt=""  class="app-img__img">
                        
                     </div>
                  </a>
                  <div class="card-body">
                     <a  href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">
                        <p  class="product-decs">{{en2bn($row->product_name)}}</p>
                     </a>
                     <div >
                        <p class="sale-price">
                     ...
                     <del class="old-price"> ৳{{en2bn($row->selling_price )}} </del>
                     ...
                     @else
                     <span class="saved-cash">আপনি ছাড় পাচ্ছেন {{ en2bn((ceil($row->selling_price - $row->discount_price))) }}৳</span> 
                     
                     @endif
                        
                        <div  class="sm-buy-btn">
                            <a href="#" class="add-to-cart" id="{{ $row->id }}" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)" data-tip="Add to Cart"><i class="fa fa-plus fa-2x"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-md-2 col-sm-6 col-6">
                <div class="product-grid4">
                    <div class="product-image4">
                        ...
                        <ul class="social">
                            <li><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>

                            <li><a href="#" class="addwishlist" data-id="{{ $row->id }} data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                            <li><a href="#" class="add-to-cart" id="{{ $row->id }}" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                        </ul>
                        @if($row->discount_price == NULL)
                        <span class="product-new-label">New</span>
                        @else
                        <span class="product-discount-label">- {{(ceil(($row->selling_price - $row->discount_price)/$row->selling_price*100))}} %</span>
                        @endif
                    </div>
                    <div class="product-content">
                        <h3 class="title"><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">{{ $row->product_name }}</a></h3>
                        <div class="price">
                            {{ $row->selling_price }}
                            <span> {{ $row->discount_price }} </span>
                        </div>
                        {{-- <button id="{{ $row->id }}" class="product_cart_button add-to-cart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add to Cart</button> --}}
                        <a class="add-to-cart" id="{{ $row->id }}" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">ADD TO CART</a>
                    </div>
                </div>
            </div>
        @endforeach
