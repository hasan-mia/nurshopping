...
<div class="contact_form">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-12 col-12" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
...
<div class="col-lg-5 col-md-5 col-sm-12 col-12" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
                    <div class="contact_form_container">
              ...
              <div class="form-row">
                <label for="card-element">
                    <ul class="car-details">
                       <li>ক্যাশঅন ডেলিভারি<li/>

                    <li> সারাদেশে ক্যাশঅন ডেলিভারি সুবিধা পেতে অবশ্যই আপনাকে ১৫০টাকা ডেলিভারি চার্জ ০১৬১৭৮৯২৩২৩ এই নাম্বার বিকাশ/নগদ/রকেট করতে হবে।</li>
