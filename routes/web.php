...
Route::get('/all-category', function () {return view('pages.allcategory');})->name('allcat');
...
// Pyment Step  MobileBanking
Route::post('user/mobilebanking/charge/', 'PaymentController@MobileBanking')->name('mobile.charge');
